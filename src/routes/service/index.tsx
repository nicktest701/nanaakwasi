...
function Service() {
  const services = [
    {
      ...
      icon: (
        <WebDevelopment className="fill-white/30 group-hover:fill-primary-500 transition-colors duration-500 size-14" />
      ),
      delay: 200,
    },
    {
      ...
      icon: (
        <MobileDevelopment className="fill-white/30 group-hover:fill-primary-500 transition-colors duration-500 size-14" />
      ),
      delay: 300,
    },
    {
      ...
      icon: (
        <DesktopDevelopment className="fill-white/30 group-hover:fill-primary-500 transition-colors duration-500 size-14" />
      ),
      delay: 400,
    },
  ];
  ...
  return (
    <section
      id="services"
      className="relative bg-secondary-900 py-20 overflow-hidden"
    >
      {/* Decorative gradient glow */}
      <div className="absolute inset-0 bg-gradient-to-b from-primary-500/5 via-transparent to-secondary-900 pointer-events-none" />
