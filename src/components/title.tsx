    ...
    <div data-aos="fade-zoom-in" className="relative w-full mx-auto py-20">
      ...
      <div className="absolute inset-0 flex flex-col items-center justify-center">
        ...
        <div className="relative w-[150px] mx-auto">
          <div className=" divider h-px  bg-white/20 w-[150px] mx-auto flex items-center justify-center"></div>
          <div className="absolute -top-px right-0 left-0   divider  bg-primary-500 h-[3px] w-[60px] mx-auto  " />
        </div>
      </div>
    </div>
  );
